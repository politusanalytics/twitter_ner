"""
****** This script is taken from https://github.com/sighsmile/conlleval/blob/master/conlleval.py ******
...
def split_tag(chunk_tag):
    ...
    if chunk_tag == 'O':
        return ('O', None)
    #print(chunk_tag.split('-', maxsplit=1))
...
def get_result(correct_chunks, true_chunks, pred_chunks,
    correct_counts, true_counts, pred_counts, verbose=False):
    """
...
def evaluate_conll_file(fileIterator):
    ...
    return evaluate(true_seqs, pred_seqs, verbose=True)
